                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php foreach ($pedidos as $pedido): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($pedido->telefone ?? 'Não informado'); ?></td>
                                    <td>
                                        <textarea class="form-control" readonly rows="3"><?php echo htmlspecialchars($pedido->motivo_contato ?? 'Sem mensagem'); ?></textarea>
                                    </td>
                                    <td>
                                        <form method="POST" action="marcar_visualizadoContato.php">
